# Maintainer: reburn <au0228@outlook.com>

pkgname=libfprint-cs9711-rebase-git
_pkgname=libfprint-CS9711
pkgver=1.94.10+1.r1866.20260216.02b285c
pkgrel=1
pkgdesc="libfprint with CS9711 fingerprint driver support (archeYR fork, cs9711-rebase branch)"
arch=(x86_64)
...
conflicts=(libfprint)
groups=(fprint)
source=("git+https://github.com/archeYR/libfprint-CS9711.git#branch=cs9711-rebase")
sha256sums=('SKIP')
